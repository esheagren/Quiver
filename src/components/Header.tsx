                ...
                <TooltipTrigger asChild>
                  <Link to="/discover">
                    <Button 
                      variant="ghost"
                      size="icon"
                      className="h-10 w-10 hover:bg-orange-100 transition-all"
                    >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button 
                    ...
                    size="icon"
                    className="h-10 w-10 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 shadow-md hover:shadow-lg transition-all duration-200 group"
                  >
